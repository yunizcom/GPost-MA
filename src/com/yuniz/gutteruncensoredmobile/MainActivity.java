package com.yuniz.gutteruncensoredmobile;
...
import com.yuniz.gutteruncensoredmobile.R;
...
//revmob.setTestingMode(RevMobTestingMode.WITH_ADS);
	...
	public void loadOldURLBtn(View v) {
		...
		if(currentURL.length() == 0){
			Toast.makeText(getApplicationContext(), "No previous history found, please click on START button." , Toast.LENGTH_LONG).show();
		}else{
